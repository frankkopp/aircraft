    ...
    return (
        <div className="w-full">
            <div className="flex flex-row items-end space-x-4">
                <h1 className="font-bold">Interior Lighting</h1>
            </div>
...
const SinglePreset = (props: { presetID: number, getPresetName: (arg0: number) => string, storePresetName: (arg0: number, arg1: string) => void, namesMap: any }) => {
    ...
    return (
        <div className="flex flex-row justify-between my-1">
            ...
            <div className="flex justify-center items-center mx-4 w-full h-28 text-theme-text bg-theme-accent rounded-md border-2 border-theme-accent">
                <SimpleInput
            ...
            <div
                className="flex justify-center items-center mx-4 w-full h-28 text-theme-text hover:text-theme-body bg-theme-accent hover:bg-theme-highlight rounded-md border-2 border-theme-accent transition duration-100 items-centerh-24"
